...
@section('content')
    ...
    <div class="user-display">
        ...
        <div class="user-display-bg"><img src="{{ asset('public\assets\img\background\bg-gl-edit.jpg') }}"
                alt="Profile Background" class="img-fluid "></div>
        <div class="user-display-bottom">
            <div class="user-display-avatar">
                <img src="{{ asset('public\assets\img\user\user-gl.jpg') }}" alt="Avatar">
    ...
    <!-- <div class="card">
        <div class="card-header"><span class="title">That is Your Machine</span></div>
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-center">
                <div class="card shadow m-2 w-30" style="width: 10rem; background-color: #FFC626">
                    <div class="container my-2">
                        <div><i class="fa-solid fa-gears fa-2x text-white"></i></div>
                        <h2 class="text-white mt-5"><b>Koike</b></h2>
                        <p class="text-white">10 Jobs</p>
