    ...
    <div class="col-sm-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
            <div class="panel-body" style="margin-left: 0px; margin-right: 0px; padding-top: 30px;">
                ...
                <table class="table table-striped table-hover table-fw-widget tableData" id="onprocessdt">
                    <thead>
...
<script>
    ...
    $(document).ready(function() {
        $('#onprocessdt').DataTable();
        $("#onprocessdt_filter").addClass("d-flex justify-content-end mb-3");
